...
import static com.baidu.unbiz.common.test.TestUtil.containsAll;
...
import com.baidu.unbiz.modules.template.Template.IncludeTemplate;
import com.baidu.unbiz.modules.template.Template.Node;
import com.baidu.unbiz.modules.template.Template.Placeholder;
import com.baidu.unbiz.modules.template.Template.PlaceholderParameter;
import com.baidu.unbiz.modules.template.Template.Text;

public class TemplateParserTest extends AbstractTemplateTest {
    @Test
    ...
    public void test08_import_invalid() throws Exception {
        String importedFile =
                StringUtil.repeat("../", StringUtil.countMatches(srcdir.toURI().toURL().toExternalForm(), "/"))
                        + "../def.htm";
        String s = "#@trimming on\n";
        s += "${abc: #abc}\n";
        s += "#abc(" + importedFile + ") ## xxxx";

        File f = new File("target/test", "testinvalid.htm");
