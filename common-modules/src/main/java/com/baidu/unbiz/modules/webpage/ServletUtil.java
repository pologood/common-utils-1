...
import static com.baidu.unbiz.common.FileUtil.normalizeAbsolutePath;
 ...
 * @version create on 2016年1月27日 下午3:32:09
 */
public class ServletUtil {
     ...
     * </p>
     * <p>
     * 注意，<code>ResourcePath</code>以<code>"/"</code>开始，如果无内容，则返回空字符串 <code>""</code>。
     * </p>
     */
     ...
     * 取得request所请求的资源路径。
     * <ul>
     * <li>对于前缀匹配的servlet，等同于<code>getPathInfo()</code>。例如映射 <code>/turbine/*</code>：<code>/turbine/xx/yy</code>
     * 的resource path为 <code>/xx/yy</code>。</li>
     * <li>对于后缀匹配的servlet，等同于 <code>getServletPath()</code>。例如映射 <code>*.do</code>：<code>/xx/yy.do</code>的resource path为
     ...
     * 取得request请求的基准URL。
     * <ul>
     * <li>对于前缀匹配的servlet，等同于<code>SERVER/contextPath/servletPath</code>。例如映射 <code>/turbine/*</code>：
     * <code>http://localhost/myapp/turbine/xx/yy</code> 的baseURL为 <code>http://localhost/myapp/turbine</code>。</li>
     * <li>对于后缀匹配的servlet，等同于<code>SERVER/contextPath</code>。例如映射 <code>*.do</code>：
     * <code>http://localhost/myapp/xx/yy.do</code>的baseURL为 <code>http://localhost/myapp</code>。</li>
     * </ul>
     * <p>
     * 基准URL总是<strong>不</strong>以<code>"/"</code>结尾。
     * </p>
