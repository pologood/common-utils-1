...
import com.baidu.unbiz.modules.webpage.build.InterfaceImplementorBuilder;

/**
 * Servlet 3.0 Support － 即使在非servlet 3.0的环境中，也不会出错。 此类会引用如下几个Servlet 3.0的接口。在Servlet 2.5的环境中，接口由
 * <code>citrus-common-servlet</code>项目提供。
 * <ul>
 * <li><code>WriteListener</code></li>
 * </ul>
 * 
 * @author <a href="mailto:xuchen06@baidu.com">xuc</a>
 * @version create on 2016年3月20日 上午2:33:55
 */
public class Servlet3Util {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Servlet3Util.class);
    ...
    static {
        ...
        if (writeListenerClass == null) {
            ...
            methodList
                    .add(new MethodInfo(null, null, ServletOutputStream.class, "setWriteListener", writeListenerClass));
        }
        ...
        asyncListenerBuilder =
                asyncListenerClass == null ? null : new InterfaceImplementorBuilder().addInterface(asyncListenerClass)
                        .setOverriderClass(MyAsyncListener.class).init();
    }
    ...
    /**
     * 设置强制禁用servlet 3.0特性。 有一种情况：当用httpunit测试时，虽然存在servlet 3.0的API包，但是由于httpunit未实现servlet 3.0而报错。 在这种情况下，可强制禁用servlet
     * 3.0，让测试通过。
     */
    ...
    public static boolean requestIsAsyncStarted(HttpServletRequest request) {
        return (Boolean) invoke(request_isAsyncStarted, request);
    }

    public static Object /* AsyncContext */requestGetAsyncContext(HttpServletRequest request) {
    ...
    public static boolean requestIsDispatcherType(HttpServletRequest request, Enum<?> type) {
    ...
    public static Object /* AsyncContext */asyncEventGetAsyncContext(Object /* AsyncEvent */event) {
        return invoke(asyncEvent_getAsyncContext, event);
    }

    public static void asyncContextAddAsyncListener(Object /* AsyncContext */asyncContext,
            Object /* AsyncListener */listener) {
        invoke(asyncContext_addListener, asyncContext, listener);
    }

    public static void requestRegisterAsyncListener(HttpServletRequest request, MyAsyncListener listenerImpl) {
        Object /* AsyncContext */asyncContext = requestGetAsyncContext(request);
        Object listener = assertNotNull(asyncListenerBuilder, "asyncListenerBuilder").toObject(listenerImpl); // builder
                                                                                                              // should
                                                                                                              // not be
                                                                                                              // null
    ...
    private static class MethodInfo {
        ...
        public <T> MethodInfo(Class<T> returnValueType, T defaultReturnValue, Class<?> declaringClass,
    ...
    public abstract static class Servlet3OutputStream extends ServletOutputStream {
