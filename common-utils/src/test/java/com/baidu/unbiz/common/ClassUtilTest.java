...
public class ClassUtilTest extends CachedLogger {
    ...
    public void getFriendlyClassName() {
        ...
        // 内联类/本地类/匿名类
        assertGetFriendlyClassName("com.baidu.unbiz.common.ClassUtilTest.Inner", new Inner());
        assertGetFriendlyClassName("com.baidu.unbiz.common.ClassUtilTest.Inner[]", new Inner[0]);
        // FIXME
        // class Local {
        // }
        //
        // assertGetFriendlyClassName("com.baidu.unbiz.common.ClassUtilTest.1Local", new Local());
        // assertGetFriendlyClassName("com.baidu.unbiz.common.ClassUtilTest.1Local[]", new Local[0]);
        ...
        assertGetFriendlyClassName("com.baidu.unbiz.common.ClassUtilTest.1", anonymous);
