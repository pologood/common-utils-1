 ...
 * @version create on 2015-3-9 下午10:46:42
 */
public class MethodSignature implements Serializable {
    ...
    static {
        Map<Class<?>, Character> map = CollectionUtil.createHashMap();
        ...
        Map<Character, Class<?>> reverseMap = CollectionUtil.createHashMap(map.size());
    ...
    private static KeyAndValue<String, Class<?>[]> parse(String internal) {
        ...
        List<Class<?>> params = CollectionUtil.createArrayList();
        ...
        switch (c) {
            ...
            default:
                throw new IllegalArgumentException(String.format(
                        "Unexpected character at index %d of method signature \"%s\"", Integer.valueOf(here), internal));
        }
    }
