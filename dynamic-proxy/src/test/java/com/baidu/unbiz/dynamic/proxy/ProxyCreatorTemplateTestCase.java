...
import com.baidu.unbiz.dynamic.proxy.provider.BeanProvider;
import com.baidu.unbiz.dynamic.proxy.provider.ConstantProvider;
import com.baidu.unbiz.dynamic.proxy.provider.SingletonProvider;
import com.baidu.unbiz.dynamic.proxy.sample.DuplicateEcho;
import com.baidu.unbiz.dynamic.proxy.sample.Echo;
import com.baidu.unbiz.dynamic.proxy.sample.EchoImpl;
import com.baidu.unbiz.dynamic.proxy.sample.SuffixInterceptor;

/**
 * ProxyCreatorTemplateTestCase
 * 
 * @author <a href="mailto:xuchen06@baidu.com">xuc</a>
 * @version create on 2015-3-9 下午11:08:11
 */
public abstract class ProxyCreatorTemplateTestCase extends AbstractTestCase {
    ...
    protected ProxyCreatorTemplateTestCase() {
    ...
    public void testDelegatingProxyInterfaceOrder() {
        ...
        List<Class<?>> expected =
                CollectionUtil.createLinkedList(Arrays.<Class<?>> asList(Echo.class, DuplicateEcho.class));
        List<Class<?>> actual = CollectionUtil.createLinkedList(Arrays.asList(echo.getClass().getInterfaces()));
    ...
    public void testInterfaceHierarchies() {
        SortedSet<String> treeSet = CollectionUtil.createTreeSet();
